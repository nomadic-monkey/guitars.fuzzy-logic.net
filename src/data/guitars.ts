export const guitars = [
  ...
  
  {
    ...
    gallery: [
      ...
      "https://www.musicradar.com/reviews/gibson-les-paul-standard-60s",
    ...
    description:
      "The Gibson Les Paul is famous for its warm sustain and solid mahogany body, loved by blues and rock players worldwide. Known for its thick tone and iconic look, it’s the cornerstone of classic rock sound.",
  },
  {
    id: "telecaster",
    ...
    description:
      "The Telecaster Custom delivers classic Fender twang with modern versatility. With its distinctive double binding and two-pickup setup, it’s ideal for country, rock, and indie tones.",
  },
  {
    id: "sg",
    name: "SG Vintage",
    ...
    description:
      "The SG Vintage offers legendary lightweight playability with razor-sharp cutaways. Its double-horn design and screaming tone made it a staple in classic rock and hard rock alike.",
  },
  {
    id: "jazzmaster",
    name: "Jazzmaster",
    ...
    description:
      "The Jazzmaster combines smooth offset curves with mellow, surf-inspired tones. With its floating tremolo and wide single-coils, it’s a favorite of experimental and indie musicians.",
  },
  {
    id: "flyingv",
    name: "Flying V",
    ...
    description:
      "The Flying V delivers radical design and searing tone. Its futuristic shape and roaring humbuckers make it a symbol of high-energy rock performance.",
  },
];
